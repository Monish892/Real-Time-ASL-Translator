...
// Import all the components used in the main page
...
const DEFAULT_WS =
  ...
  "wss://real-time-asl-translator.onrender.com/ws/translate";
...
function App() {
  ...
  const [sentenceState, setSentenceState] =
    useState<SentenceState>(initialSentenceState);
